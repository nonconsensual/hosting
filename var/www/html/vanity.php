...
echo '<p>Want a Vanity URL ? yourname.onion ? well its simple before you register send me a $10 donation to my bitcoin address and i will generate a custom private key for you (All donations go towards server upkeep costs, keeping the server live.)</p>';
echo '<p><b>(once you have sent the donation click the contact form! and advise me you sent a donation and include your email address please allow 24 hours for me to make the custom key)</b></p>';
echo '<li><b>MyBitcoin Address: Your Bitcoin Address Here</b></li>';
echo '<p>What you will get:</p>';
echo '<ul>';
echo '<li>Chose a name for your vanity url key no more then 7 letters.(example:AnonSite.onion)</li>';
echo '<li>i will then send you the key by email you can paste it in the custom key box and setup your new hosting account with a cool memorable address.</li>';
echo '<li><b><a href="/contact.php" target="_blank">Click Here To Contact Me</b></li>';
echo "</div></div>\n";
echo "<footer class=\"w3-container w3-center w3-dark-grey\">\n";
echo "<p></p>\n";
echo "</footer>\n";
echo "</div>\n";
echo "<span class=\"w3-bottom w3-bar w3-tag w3-dark-grey\" style=\"cursor:url(/bugs.png),url(/myBall.cur),auto;\"><strong style=\"color:#cccccc\">hostingmrnkolxhi.onion</strong></span>\n";
echo "</body>\n";
echo "</html>";
